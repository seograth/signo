...
* In modelisimo folder, run "python main.py" for creation of model based on preprocessed data
* If you want to record some data navigate to folder src/data and run "python create_dataset.py" to create a .csv with hand landmarks